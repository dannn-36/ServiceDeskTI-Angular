...
- Create Angular project with ng: `ng new servicedeskng.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`servicedeskng.client.esproj`).
